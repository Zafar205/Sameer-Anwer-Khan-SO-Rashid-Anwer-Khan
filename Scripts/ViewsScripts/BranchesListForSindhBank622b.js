...
function populateBranchGrid(id) {
    ...
    {
        $.ajax({
            url: base_url_service_layer + '/api/Proxy/Locations/GetPublicBranchesForSindhBankByDistrictId?districtId=' + id,
            type: 'POST',
...
function populateBranchGridWithAllBranches() {    
    initializeBranchGrid();
        $.ajax({
            url: base_url_service_layer + '/api/Proxy/Locations/GetAllPublicBranchesForSindhBank',
            type: 'POST',
            contentType: "application/json;charset=utf-8",
            success: function (data) {                              
                SetReportGrids(data);
